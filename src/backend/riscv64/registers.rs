...
pub const FA0: u8 = F10;
/// FP argument 1 / second FP return value (f11).
pub const FA1: u8 = F11;
/// FP argument 2 (f12).
pub const FA2: u8 = F12;
/// FP argument 3 (f13).
pub const FA3: u8 = F13;
/// FP argument 4 (f14).
pub const FA4: u8 = F14;
/// FP argument 5 (f15).
pub const FA5: u8 = F15;
/// FP argument 6 (f16).
pub const FA6: u8 = F16;
/// FP argument 7 (f17).
pub const FA7: u8 = F17;
/// FP saved register 2 (f18).
pub const FS2: u8 = F18;
/// FP saved register 3 (f19).
pub const FS3: u8 = F19;
/// FP saved register 4 (f20).
pub const FS4: u8 = F20;
/// FP saved register 5 (f21).
pub const FS5: u8 = F21;
/// FP saved register 6 (f22).
pub const FS6: u8 = F22;
/// FP saved register 7 (f23).
pub const FS7: u8 = F23;
/// FP saved register 8 (f24).
pub const FS8: u8 = F24;
/// FP saved register 9 (f25).
pub const FS9: u8 = F25;
/// FP saved register 10 (f26).
pub const FS10: u8 = F26;
/// FP saved register 11 (f27).
pub const FS11: u8 = F27;
/// FP temporary 8 (f28).
pub const FT8: u8 = F28;
/// FP temporary 9 (f29).
pub const FT9: u8 = F29;
/// FP temporary 10 (f30).
pub const FT10: u8 = F30;
/// FP temporary 11 (f31).
pub const FT11: u8 = F31;
...
pub const RESERVED_GPRS: &[u8] = &[X0, X1, X2, X3, X4];
...
pub const ARGUMENT_GPRS: &[u8] = &[X10, X11, X12, X13, X14, X15, X16, X17];

/// Floating-point argument registers fa0–fa7 (f10–f17), ordered by ABI convention.
pub const ARGUMENT_FPRS: &[u8] = &[F10, F11, F12, F13, F14, F15, F16, F17];

/// Integer return registers a0–a1 (x10–x11).
pub const RETURN_GPRS: &[u8] = &[X10, X11];

/// Floating-point return registers fa0–fa1 (f10–f11).
pub const RETURN_FPRS: &[u8] = &[F10, F11];
...
impl RiscV64RegisterInfo {
    ...
    #[inline]
    pub fn allocatable_regs(&self, class: RegClass) -> &'static [u8] {
        match class {
    ...
    #[inline]
    pub fn caller_saved(&self) -> &'static [u8] {
        CALLER_SAVED_GPRS
    }

    /// Returns the frame pointer register ID (x8 / s0 / fp).
    #[inline]
    pub fn frame_pointer(&self) -> u8 {
        FP
    }
    ...
    ///
    /// This converts the `u8` register IDs used internally by the RISC-V
